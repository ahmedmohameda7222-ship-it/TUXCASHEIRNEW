...
describe('Task 9E notification envelope privacy fence', () => {
  it('returns generic-only metadata when no ACTIVE current operator is server-authorized', async () => {
  ...
  it('allows only safe text/customer preview after server ACTIVE-operator authorization', async () => {
