...
-- Canonical delivery authority must survive the trusted ONLINE inbox/claim boundary.
  ...
  from (
    select
      ...
      jsonb_build_object(
        ...
        'requestedShopId', coalesce(request.requested_shop_id, request.shop_id),
        'deliveryZoneId', request.delivery_zone_id,
        'deliveryZoneName', request.delivery_zone_name,
        'deliveryFeeMinor', request.delivery_fee_minor,
        'deliveryMinimumOrderMinor', request.delivery_minimum_order_minor,
        'deliveryFallbackUsed', request.delivery_fallback_used,
...
begin
  ...
  return jsonb_build_object(
    ...
    'requestedShopId', coalesce(v_request.requested_shop_id, v_request.shop_id),
    'deliveryZoneId', v_request.delivery_zone_id,
    'deliveryZoneName', v_request.delivery_zone_name,
    'deliveryFeeMinor', v_request.delivery_fee_minor,
    'deliveryMinimumOrderMinor', v_request.delivery_minimum_order_minor,
    'deliveryFallbackUsed', v_request.delivery_fallback_used,
