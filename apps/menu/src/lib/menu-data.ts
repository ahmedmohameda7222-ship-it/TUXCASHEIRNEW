...
export const PRODUCTS: Product[] = [
  // Tux Burger
  {
    ...
    description:
      'The classic Tux. 150g pure beef patty, melted cheddar, crisp lettuce, fresh tomato, onions, and our signature Tux sauce on a toasted brioche bun.',
    price: 190,
  ...
  },
  {
    ...
    description:
      'Double the pleasure. Two 150g beef patties stacked with double cheddar, crisp lettuce, fresh tomato, onions, and signature Tux sauce.',
    price: 250,
    image_url: TUX_LOGO_PLACEHOLDER,
  ...
  },
  {
    ...
    description:
      'For the truly hungry. Three 150g beef patties, triple cheddar, crisp lettuce, fresh tomato, onions, and signature Tux sauce.',
    price: 310,
    image_url: TUX_LOGO_PLACEHOLDER,
    is_best_seller: false,
    is_available: true,
  ...
  },
  {
    ...
    name: 'TUX Quatro',
    description:
      'The ultimate mountain of meat. Four 150g beef patties, melted cheese layers, and our signature Tux sauce.',
    price: 360,
    image_url: TUX_LOGO_PLACEHOLDER,
    is_best_seller: true,
    is_available: true,
  ...
  // Hawawshi
  {
    ...
    description:
      'Authentic Egyptian Hawawshi with high quality spiced minced meat baked to crispy perfection.',
    price: 120,
    image_url: TUX_LOGO_PLACEHOLDER,
    is_best_seller: false,
    is_available: true,
  ...
  },
  {
    ...
    name: 'TUX Hawawshi',
    description:
      'Our signature Hawawshi loaded with extra high quality meat, special spices, and melted cheese.',
    price: 150,
    image_url: TUX_LOGO_PLACEHOLDER,
    is_best_seller: true,
    is_available: true,
