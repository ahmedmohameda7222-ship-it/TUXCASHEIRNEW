...
export const PRODUCTS: Product[] = [
  // Tux Burger
  {
    ...
    price: 190,
    image_url: "/src/assets/tuxlogo.jpg", // placeholder if we don't have exact
    is_best_seller: true,
    is_available: true,
    sort_order: 1,
  },
  {
    ...
    price: 250,
    image_url: "/src/assets/tuxlogo.jpg",
  ...
  // Tuxify
  {
    ...
    category_id: "tuxify",
    name: "Single Tuxify",
    description: "Premium single patty with our rich Tuxify sauce, caramelized onions, and premium cheddar on a soft brioche bun.",
    price: 180,
  ...
  },
  {
    ...
    category_id: "tuxify",
    name: "Triple Tuxify",
    description: "Three layers of premium beef, melted cheddar, sweet caramelized onions, and rich Tuxify sauce.",
    price: 300,
  ...
  },
  {
    ...
    category_id: "tuxify",
    name: "Quatro Tuxify",
    description: "Four premium patties, layers of melted cheddar, caramelized onions, and abundant Tuxify sauce.",
    price: 360,
  ...
  // Hawawshi
  {
    ...
    description: "Authentic Egyptian Hawawshi with premium spiced minced meat baked to crispy perfection.",
    price: 120,
    image_url: "/src/assets/tuxlogo.jpg",
    is_best_seller: false,
    is_available: true,
  ...
  },
  {
    ...
    category_id: "hawawshi",
    name: "TUX Hawawshi",
    description: "Our signature Hawawshi loaded with extra premium meat, special spices, and melted cheese.",
    price: 150,
    image_url: "/src/assets/tuxlogo.jpg",
    is_best_seller: true,
    is_available: true,
