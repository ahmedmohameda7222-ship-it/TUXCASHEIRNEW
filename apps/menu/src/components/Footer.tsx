      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
        ...
        <div>
          ...
          <p className="text-muted/80 text-sm max-w-xs">
            Premium burgers made fresh. Built for the chase. Experience the best street-food burger
            in Egypt.
          </p>
        </div>
        ...
        {/* Center */}
        <div>
          <h4 className="text-white font-sans uppercase tracking-widest text-sm mb-6">
            Quick Links
          </h4>
          <ul className="space-y-4">
            <li>
              <NavLink href="/" className="text-muted hover:text-primary transition-colors text-sm">
                Home
              </NavLink>
            </li>
            <li>
